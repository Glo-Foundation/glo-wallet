    ...
    <>
      ...
      <div className="flex flex-col space-y-4 text-pine-900 mt-3 mb-5 mx-4 text-sm">
        ...
        <ol className="list-decimal mx-4">
          ...
          <li>Buy {glo + 1} USDC on Coinbase via wire transfer</li>
          <li>Send {glo + 1} USDC to: 0x...ef81 🔗 on Polygon</li>
          ...
          <li>Input {glo} USDC and click “Swap”</li>
          <li>Complete the Uniswap steps to buy 1000 Glo!</li>
        </ol>
      </div>
    </>
  );
