...
import { celo, celoAlfajores, Chain } from "@wagmi/core/chains";
...
export const getAvgMarketCap = async (
  ...
  try {
    ...
    const topic =
      "0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef"; // sha3('Transfer(address,address,uint256)') => topic
