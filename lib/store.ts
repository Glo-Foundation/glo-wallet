...
export const useUserStore = create<UserStore>((set) => ({
  ...
  setRecentlyUsedWc: (recentlyUsedWc: wcType) =>
    set(() => ({ recentlyUsedWc })),
}));

type wcType = "stellar" | "wc";
